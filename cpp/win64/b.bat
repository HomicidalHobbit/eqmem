...
/c /EHsc /I.. /I"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.23.28105\include" ^
/I"C:\Program Files (x86)\Windows Kits\10\Include\10.0.18362.0\ucrt" ^
..\eqmem.cpp ..\memmanager.cpp ..\memtracker.cpp ..\bin.cpp ..\bucket.cpp
